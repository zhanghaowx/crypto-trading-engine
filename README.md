...
- 🎯 Entry points to execute your program using `python -m <crypto_trading_engine>` or `$ crypto_trading_engine` with basic CLI argument parsing.
...
Awesome crypto_trading_engine created by zhanghaowx

## Install it from PyPI

```bash
pip install crypto_trading_engine
```

## Usage

```py
from crypto_trading_engine import BaseClass
from crypto_trading_engine import base_function
...
```bash
$ python -m crypto_trading_engine
#or
$ crypto_trading_engine
```
