...
def heartbeat_script():
    ...
    from jolteon.dashboard.health_summary import heartbeats
...
def summary_script():
    ...
    from jolteon.dashboard.health_summary import summary
...
def nav_script_without_drawing():
    ...
    from jolteon.dashboard.health_summary import redraw_nav_if_stale
